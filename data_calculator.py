...
class DataCalculator:
    ...
    def get_vector(point, foot):
        return Vector(
            ...
            z=point.altitude-foot.altitdue
        )
    ...
    def get_angle_between_vectors(vector_1, vector_2):
        return int(
            arccos(
                DataCalculator.get_cross_product(vector_1, vector_2) / (DataCalculator.get_vector_length(vector_1) * DataCalculator.get_vector_length(vector_2))
            )
        )
